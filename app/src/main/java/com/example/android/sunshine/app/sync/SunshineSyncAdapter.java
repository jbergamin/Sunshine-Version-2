...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final int SYNC_INTERVAL = 240;
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        if(locationQuery == null){
            Log.w(LOG_TAG, "No location extra in intent.  Cannot fetch weather.");
            return;
        }
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(KEY_PARAM, mContext.getString(R.string.api_key))
                    .build();
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        // query content provider to determine if location already exists in db
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                // Delete old weather data from db.
